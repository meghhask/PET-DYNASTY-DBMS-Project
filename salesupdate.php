...
<div class="topnav">
            ...
            <a href="sales.php">Sales Details to Update</a>
...
<form method="post" action="salesupdate.php">
  ...
  <fieldset>
    ...
    <input type="text"  id ="sd" name="id" placeholder="Enter the sales id" style="width:99%;height:30px;
    border: 2px solid rgba(249, 105, 14, 1); border-radius:5px;" required>
   <br><br>
   <input type="text" name="csid" placeholder="Enter the customer id" style="width:99%;height:30px;
    border: 2px solid rgba(249, 105, 14, 1);border-radius:5px; " required>
  <br><br>
   <input type="date" name="date" style="width:100%;height:30px;
   border: 2px solid rgba(249, 105, 14, 1);border-radius:5px;" required>
  <br><br>
  <input type="number" name="total" min="0" style="width:99%;height:30px;
   border: 2px solid rgba(249, 105, 14, 1);border-radius:5px;" required placeholder="Enter total amount">
  <br><br>
  <input type="submit" name="submit" value="Update" style="width:100px;height:30px;border-radius:5px;
