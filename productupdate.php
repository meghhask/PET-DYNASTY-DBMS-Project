...
<div class="topnav">
            ...
            <a href="petproducts.php">Pet Product to Update</a>
            <div class="topnav-right">
              <a href="petproducts.php">Back</a>
            </div>
          </div>
    <!-- <form>
...
<fieldset> 
   <input type="text" name="id" placeholder=" Enter product_id" style="width:98%;height:30px;
   border: 2px solid  #f44336; border-radius:3px;  background:transparent;" required>
  <br><br>
  <input type="text" name="name" placeholder=" Enter product name" style="width:98%;height:30px;
   border: 2px solid  #f44336; border-radius:3px;  background:transparent;" required>
  <br><br>
   <input type="text" name="type" placeholder=" Enter product type" style="width:98%;height:30px;
   border: 2px solid  #f44336; border-radius:3px;  background:transparent;" required>
  <br><br>
  ...
  <br><br>
  <input type="text" name="belong" placeholder=" Pet category it belongs to" style="width:98%;height:30px;
   border: 2px solid  #f44336; border-radius:3px;  background:transparent;" required>
  <br><br>
  <input type="submit" name="submit" value="Update"  placeholder=" which pet category it belongs to" style="width:100px;height:30px;
   border: 2px solid  #2b3d40; border-radius:3px; cursor:pointer;background-color:#f44336">&ensp; 
</fieldset>
</form> 
</body>
</html>
